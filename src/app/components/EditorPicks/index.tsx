// src/app/components/EditorPicks/index.tsx
  ...
  return (
    <section className="container mx-auto mt-20 px-4" style={{ width: '1050px', padding: '80px 0', gap: '48px' }}>
      <div className="text-center mb-12" style={{ width: '607px', height: '62px', margin: '0 auto', gap: '10px', transform: 'translateY(-20px)' }}>
        <h2 className="text-3xl font-bold whitespace-nowrap" style={{ width: '181px', height: '32px', fontFamily: 'Montserrat', fontSize: '24px', lineHeight: '32px', letterSpacing: '0.1px', color: '#252B42', margin: '0 auto' }}>EDITOR'S PICK</h2>
